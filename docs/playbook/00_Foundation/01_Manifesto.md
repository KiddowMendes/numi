...
> A constitution for NUMI. If a feature contradicts this document, the feature is wrong.
...
In South Africa, money often arrives as a lump sum — a grant, a bursary payout, a weekend job, a stokvel withdrawal, a mashonisa loan — and must survive until the next lump sum. The tools built for monthly salary earners do not fit this rhythm. The result is invisible spending: R20 here, R50 there, until the money is gone and the regret arrives.

This is not a failure of character. It is a failure of visibility. Information arrives too late to be useful.

We also know that shame does not work. Locking a card, hiding a purchase, or sending a scolding notification only teaches people to avoid the tool. NUMI will never punish a user for being human.
...
This world does not require wealth. It requires clarity. And clarity should be free.
...
When someone opens NUMI, we promise:

1. **You will understand your money without friction.** No tutorials, no onboarding walls, no financial jargon.
2. **You will never need an account for the core experience.** Your primary data stays on your device. You are not the product.
3. **You will never be locked out of your own information.** No paywalls on history, no export fees for data you created.
4. **You will be able to log any transaction without interruption.** If the design adds steps, the design has failed.
5. **You will see a number that tells you what is safe to spend right now.** That number will update in real time.

---

## What NUMI Asks in Return

We do not ask for money from everyone. But we do ask for honesty — with yourself. NUMI only works if the numbers entered are true. We cannot prevent a user from lying to the app. We build for the user who wants to stop lying to themselves.

---

## The One Sentence

> **NUMI exists to make invisible spending visible in the moment — free for everyone, with those who can afford more funding those who can't.**

This sentence is the final arbiter of every dispute. When two features conflict, the one that serves this sentence wins. When a business model compromises this sentence, the business model loses.

---

## What Happens After This Document

This Manifesto is locked until v1 ships. It may be revised only by explicit decision of the owner, and only if the revision strengthens — never weakens — the Principles above.

Next: `docs/playbook/00_Foundation/02_Principles.md` — the operational rules that derive from this Manifesto.
